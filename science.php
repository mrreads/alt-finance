...
<head>
    ...
    <title>Научно-исследовательская деятельность - АЛЬТЕРНАТИВНЫЕ ФИНАНСЫ</title>
...
<div class="container page-services" style="padding-bottom: 0;">
    <div class="c-main">
        <div class="page-service-title" style="background-image: url('./resources/img/webp/services/kafedra.webp');">
