...
<head>
    ...
    <title>О компании Альтернативные Финансы</title>
        ...
        <div class="c-left">
            <div class="c-main class1" style="background-color: rgba(255, 255, 255, 0.8);">
                ...
                <div class="about-big-img" style="background-image: url('./resources/img/webp/about/image81.webp');">
                    ...
                    <h1 class="service-title wow fadeInLeft" data-wow-duration="1.4s">Мы - пактинговая компания</h1>
                    ...
                    <div class="swiper-container">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <a class="slider-item about" href="#" style="background-image: url('./resources/img/webp/about/rjd1.webp');">  </a>
                                <p>РЖД</p> 
                            </div>
                            <div class="swiper-slide">
                                <a class="slider-item about" href="#" style="background-image: url('./resources/img/webp/about/rjd1.webp');">  </a>
