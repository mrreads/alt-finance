 ...
 <footer class="footer">
    <div class="container">
        <a href="https://synapsenet.ru/searchorganization/organization/1107746561713-ooo-alternativnie-finansi#org-group-relationship" target="_blank" class="synapse-alt-finance">
            <img src="./resources/img/icons/synapse.png" alt="synapse">
        </a>
