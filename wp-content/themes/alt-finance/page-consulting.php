...
<div class="container page-services" style="padding-bottom: 0;">
    <div class="c-main">
        <div class="page-service-title" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/webp/services/consalting.webp');">
            <h2>консалтинг</h2>
            <p>​ Одним из основных видов деятельности компании «Альтернативные финансы» является консалтинг.
