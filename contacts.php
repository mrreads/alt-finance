...
<section class="content contacts">
    <div class="container container-contacts">
        ...
        <div class="c-left">
            ...
            <div class="c-main c-main-contacts" style="background-color: rgb(255, 255, 255);">
                <div class="c-up">
                    <div class="adr">
                    ...
                    <div class="c-tel">
                        ...
                        <p class="first tel">+7 (900) 999 99-99 
                            <br>генеральный директор</p>
                        <p class="tel">+7 (900) 999 99-99
                            <br>отдел продаж</p>
                        <p class="tel">+7 (900) 999 99-99
                            <br>менеджеры</p>
                        <p class="tel">+7 (900) 999 99-99
                            <br>Сережа, ТЗ писал</p>
                    </div>
                </div>
