...
<head>
    ...
    <title>IT-услуги - АЛЬТЕРНАТИВНЫЕ ФИНАНСЫ</title>
...
<div class="container page-services" style="padding-bottom: 0;">
    <div class="c-main">
        <div class="page-service-title" style="background-image: url('./resources/img/webp/services/it.webp');">
            <h2>IT-услуги</h2>
            <p>Мы предоставляем широкий спектр услуг в IT-сфере, позволяющий нам полностью оптимизировать все бизнесс-процессы вашей организации </p>
        </div>
    </div>
</div>
